...
Create well-structured Agent Skills for Codex following best practices.
...
| Location | Use Case |
|----------|----------|
| `~/.Codex/skills/` | Personal, experimental |
| `.Codex/skills/` | Team/project, git-tracked |
...
3. **Clear instructions** written for Codex
