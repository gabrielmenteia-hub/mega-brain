"""Chunking for Traffic Secrets (RB54D) — Russell Brunson"""
import json, re
...
SOURCE_PATH = "inbox/RUSSELL BRUNSON (Russell Brunson)/BLUEPRINTS/Traffic Secrets.txt"
CHUNK_SIZE = 300

ROOT = Path("c:/Users/Gabriel/MEGABRAIN")

with open(ROOT / SOURCE_PATH, "r", encoding="utf-8") as f:
    raw = f.read()
