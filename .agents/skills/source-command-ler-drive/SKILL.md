---
name: "source-command-ler-drive"
description: "Lê e cria recursos do Google Drive (planilhas, pastas, documentos) via MCP"
---

# source-command-ler-drive

Use this skill when the user asks to run the migrated source command `ler-drive`.
