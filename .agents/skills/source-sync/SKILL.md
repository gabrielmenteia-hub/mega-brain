...
snapshot = load_json("/.Codex/mission-control/PLANILHA-INDEX.json")
...
save_json(snapshot, "/.Codex/mission-control/PLANILHA-INDEX.json")
```
...
| Arquivo | Propósito |
|---------|-----------|
| `.Codex/mission-control/PLANILHA-INDEX.json` | Snapshot da planilha (915+ entries) |
| `.Codex/mission-control/SOURCE-SYNC-STATE.json` | Estado da última sincronização |
| `.Codex/mission-control/DELTA-PENDING.json` | Arquivos novos pendentes |
| `.Codex/scripts/source-sync.py` | Script de detecção de delta |
| `.Codex/hooks/session-source-sync.py` | Hook de início de sessão |
