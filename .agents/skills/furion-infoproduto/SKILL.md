...
#### MONEYCLUB PROMPTS (Prompt Templates Prontos — usar diretamente no ChatGPT/Codex)
> **Fonte:** Tiago Brendon / MoneyClub (TB014) — Prompts Exclusivos
> **Como usar:** JARVIS prepara o DATA, você cola o prompt + DATA no ChatGPT ou Codex e gera direto.
