...
**No Codex:** Use a ferramenta `Skill`. Quando invocar uma skill, seu conteúdo é carregado e apresentado - siga-o diretamente. Nunca use Read tool em arquivos de skill.
