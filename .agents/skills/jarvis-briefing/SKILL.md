...
```
.Codex/jarvis/STATE.json         # Estado global do sistema
.Codex/jarvis/PENDING.md         # Lista de pendências
.Codex/jarvis/JARVIS-MEMORY.md   # Memória relacional
.Codex/jarvis/CURRENT-TASK.md    # Tarefa atual em andamento
```
...
Salvar briefing em: `.Codex/jarvis/JARVIS-BRIEFING.md`
...
- Arquivo salvo em `.Codex/jarvis/JARVIS-BRIEFING.md`
