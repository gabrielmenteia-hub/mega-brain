...
Use este skill quando precisar acessar sites que Codex não consegue (Reddit, sites com bloqueio).
...
/gemini "melhores práticas Codex reddit"
```
...
```bash
python3 .Codex/skills/gemini-fallback/gemini_fetch.py "URL_OU_QUERY"
```
