"""Chunking for Marketing Secrets Blackbook (RB2DF) — Russell Brunson"""
import json, re
...
SOURCE_PATH = "inbox/RUSSELL BRUNSON (Russell Brunson)/BLUEPRINTS/Marketing Secrets Blackbook Pt Russell Brunson.txt"
CHUNK_SIZE = 300
