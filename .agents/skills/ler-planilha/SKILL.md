...
```
Ler: .Codex/mission-control/SPREADSHEET-SCHEMA.json
```
...
- `.Codex/mission-control/SPREADSHEET-SCHEMA.json` - Schema central
- `.Codex/mission-control/SMART-SCAN.md` - Protocolo de scan
- `.Codex/mission-control/AUDIT-REPORT-V2.json` - Ultimo audit
